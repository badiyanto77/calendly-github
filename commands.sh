...
docker tag calendly:latest 891662393358.dkr.ecr.us-east-2.amazonaws.com/calendly:latest

##you can get above URI from AWS ECR console
## Command to connect to AWS ECR
## aws ecr get-login-password --region us-east-1 | docker login --username AWS --password-stdin 891662393358.dkr.ecr.us-east-2.amazonaws.com
...
docker push 891662393358.dkr.ecr.us-east-2.amazonaws.com/calendly:latest
